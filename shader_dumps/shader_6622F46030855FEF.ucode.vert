...
/*    7   */          vfetch_full r0._xzy, r0.x, vf0, DataFormat=FMT_32_32_32_FLOAT, Stride=14, Signed=true, NumFormat=integer, PrefetchCount=6
/*    8   */          vfetch_mini r2.xy__, Offset=4, DataFormat=FMT_32_32_FLOAT, Signed=true, NumFormat=integer
/*    9   */          vfetch_full r3.wzyx, r0.x, vf0, Offset=8, DataFormat=FMT_8_8_8_8, Stride=14, NumFormat=integer, PrefetchCount=5
/*   10   */          vfetch_mini r1, Offset=9, DataFormat=FMT_32_32_32_32_FLOAT, Signed=true, NumFormat=integer
/*   11   */          serialize
                      setp_ne r0._, c40.x
/*    0.1 */ (!p0) jmp L6
/*    1.0 */       exec
