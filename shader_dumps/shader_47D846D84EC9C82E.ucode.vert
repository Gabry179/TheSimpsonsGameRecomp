...
/*    7   */          vfetch_full r0._xzy, r0.x, vf0, DataFormat=FMT_32_32_32_FLOAT, Stride=12, Signed=true, NumFormat=integer, PrefetchCount=7
/*    8   */          vfetch_mini r2.xy__, Offset=4, DataFormat=FMT_32_32_FLOAT, Signed=true, NumFormat=integer
/*    9   */          vfetch_mini r3.wzyx, Offset=6, DataFormat=FMT_8_8_8_8, NumFormat=integer
/*   10   */          vfetch_full r1, r0.x, vf0, Offset=7, DataFormat=FMT_32_32_32_32_FLOAT, Stride=12, Signed=true, NumFormat=integer
/*   11   */          serialize
                      setp_ne r0._, c40.x
/*    0.1 */ (!p0) jmp L6
/*    1.0 */       exec
